...
export const PageHome = () => {
  ...
  return (
    <Box sx={{ pb: 8 }}>
      ...
      <Paper 
        sx={{ 
          backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url(https://static.kinhtedothi.vn/w960/images/upload/2024/09/17/u21918-slide-8881.jpg)',
      ...
      >
        <Container maxWidth="lg" sx={{ textAlign: 'center' }}>
          ...
          <Typography 
            variant="body1" 
            paragraph
            sx={{ mb: 4, textShadow: '1px 1px 2px rgba(0,0,0,0.5)', maxWidth: '800px', mx: 'auto' }}
          >
